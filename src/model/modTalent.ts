...
namespace modTalent {
     ...
     * 解锁条件：
     * 1:[[1,2], [8, 9], [15, 16]]， 无条件
     * 2:[[3,4], [10, 11], [17, 18]]，1层等级总和达到10
     * 3:[[5,6], [12, 13], [19, 20]]，1、2层等级总和达到30
     * 4:[7, 14, 21]，1、2、3层等级总和达到60
     */
    /**天赋的分布2-2-2-1 */
    var distribute = {
        "1":[[1,2], [8, 9], [15, 16]],
     ...
     * 3. cur = [[1,10]], talent = [[1, 10], [2, 0], [8, 0], [9, 0], [15, 0], [16, 0], [3, 0], [4, 0]]
     * 4. cur = [[1,5], [2,5]], talent = [[1, 10], [2, 0], [8, 0], [9, 0], [15, 0], [16, 0], [3, 0], [4, 0]]
     * 5. cur = [[1,10], [3,1]], talent = [[1, 10], [2, 0], [8, 0], [9, 0], [15, 0], [16, 0], [3, 1], [4, 0]]
     */
    /**
     * 每种天赋的总点数
     */
